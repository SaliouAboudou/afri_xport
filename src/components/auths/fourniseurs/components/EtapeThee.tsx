              ...
              <div className=' mx-auto flex w-full px-6'>
                ...
                <form className=' px-auto flex w-full flex-col gap-3.5' action="">
                  ...
                  <div className=' w-full flex flex-col flex-wrap  gap-y-3'>
                    <label className=' text-gray-600 font-semibold text-md ' htmlFor="email">Dénomination sociale</label>
                  ...
                  <div className=' w-full flex flex-col flex-wrap  gap-y-3'>
                    <label className=' text-gray-600 font-semibold text-md ' htmlFor="email">Numéro d’immatriculation</label>
                      <input className=' text-gray-600 border border-gray-300 w-full py-2 md:py-3 rounded-lg px-4  focus:ring-offset-1 focus:outline-amber-500 focus:outline-1 focus:ring-amber-200 ' type="email" name='email' />
                  </div>
                  {/* Secteur d activite  */}
                  <div className=' w-full flex flex-col flex-wrap  gap-y-3'>
                    <label className=' text-gray-600 font-semibold text-md ' htmlFor="email">Secteur d’activité</label>
                      <input className=' text-gray-600 border border-gray-300 w-full py-2 md:py-3 rounded-lg px-4  focus:ring-offset-1 focus:outline-amber-500 focus:outline-1 focus:ring-amber-200 ' type="email" name='email' />
                  </div>
                  {/* Pays  */}
                  <div className=' w-full flex flex-col flex-wrap  gap-y-3'>
                    <label className=' text-gray-600 font-semibold text-md ' htmlFor="email">Pays / Ville</label>
                      <input className=' text-gray-600 border border-gray-300 w-full py-2 md:py-3 rounded-lg px-4  focus:ring-offset-1 focus:outline-amber-500 focus:outline-1 focus:ring-amber-200 ' type="email" name='email' />
                  </div>
                  {/* Buttons Actions  */}
